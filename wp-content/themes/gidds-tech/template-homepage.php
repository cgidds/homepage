        ...
        echo "<div class='portfolio-items'>";
            echo "<div class='portfolio-item'>";
                echo "<div class='portfolio-thumb'>";
                    echo "<a href='https://hillsong.com'><img src='/wp-content/uploads/2017/10/portfolio-screenshot-hillsong-sm.jpg' alt='Portfolio - Hillsong Church'></a>";
                echo "</div>";
                echo "<div class='portfolio-name'>Hillsong Church</div>";
            echo "</div>";
            echo "<div class='portfolio-item'>";
                echo "<div class='portfolio-thumb'>";
                    echo "<a href='https://graceofgalway.com'><img src='/wp-content/uploads/2017/10/portfolio-screenshot-graceofgalway-sm.jpg' alt='Portfolio - Grace of Galway' style='height: 161px; width: 300px;'></a>";
                echo "</div>";
                echo "<div class='portfolio-name'>Grace of Galway</div>";
            echo "</div>";
            echo "<div class='portfolio-item'>";
                echo "<div class='portfolio-thumb'>";
                    echo "<a href='http://warriorofgod.com.au'><img src='/wp-content/uploads/2017/10/portfolio-screenshot-warriorofgod-sm.jpg' alt='Portfolio - Warrior of God' style='height: 161px; width: 300px;'></a>";
                echo "</div>";
